        ...
        for attempt in range(max_retries):
            try:
                ...
                if "rate_limit_exceeded" in error_str:
                    ...
                    print(f"Rate limit reached. Waiting {wait_time:.2f} seconds before retry. Attempt {attempt+1}/{max_retries}")
                    ...
                    raise LLMAPIError(f"Failed to get completion from language model: {error_str}") from e
        ...
        for attempt in range(max_retries):
            try:
                ...
                if "rate_limit_exceeded" in error_str:
                    ...
                    # Wrap in domain-specific exception
                    raise LLMAPIError(f"Failed to get async completion from language model: {error_str}") from e
...
if __name__ == "__main__":
    ...
    print(llm_handler._get_completion("Hello, world!"))
    print(llm_handler._get_completion_async("Hello, world!"))
    print(llm_handler._extract_questions("Hello, world!"))